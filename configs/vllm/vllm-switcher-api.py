...
MODELS = {
    ...
    'comfyui': 'jib-mix-flux-fp4',
}

# Models served on port 8003 (SDXL A1111-compat)
IMAGE_MODELS = {'imagegen'}
# Models served on port 8188 (ComfyUI)
COMFYUI_MODELS = {'comfyui'}
